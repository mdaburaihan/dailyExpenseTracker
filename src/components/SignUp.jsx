...
function SignUp() {
    ...
    return (
        <div className="w-full mx-auto">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mx-100" onSubmit={handleSubmit(create)}>
                <div className="mb-4">
                    ...
                    />
                    {errors && errors.fullname && <p className="text-red-500 text-xs italic">Invalid full name</p>}
                </div>
                <div className="mb-4">
